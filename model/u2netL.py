...
class U2NetL(Model):
    def __init__(self, rsu_middle_filters, rsu_out_filters, num_class, end_activation='softmax', only_output=False):
        ...
        self.down_rsu5 = RSU4(middle_filters=self.rsu_middle_filters, out_filters=self.rsu_out_filters)

        self.rsu6 = RSU4(middle_filters=self.rsu_middle_filters, out_filters=self.rsu_out_filters)

        self.up = UpSampling2D()
        self.up_rsu5 = RSU4(middle_filters=self.rsu_middle_filters, out_filters=self.rsu_out_filters)
...
class RSU7(Model):
    def __init__(self, middle_filters, out_filters):
        ...
        self.cbr_7 = Con_Bn_Act(filters=self.middle_filters, name='rsu7_cbr_7')
...
class RSU6(Model):
    def __init__(self, middle_filters, out_filters):
        ...
        self.cbr_6 = Con_Bn_Act(filters=self.middle_filters, name='rsu6_cbr_6')
...
class RSU5(Model):
    def __init__(self, middle_filters, out_filters):
        ...
        self.cbr_5 = Con_Bn_Act(filters=self.middle_filters, name='rsu5_cbr_5')
...
class RSU4(Model):
    def __init__(self, middle_filters, out_filters):
        ...
        self.cbr_4 = Con_Bn_Act(filters=self.middle_filters, name='rsu4_cbr_4')
